...
uint256 hashGenesisBlock("0x0327e4a95fd6c745f97bb082b1352a59ea83ab3881e4245c22044ffa8eaf1df0");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // PlastiCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PlastiCoin Signed Message:\n";
...
{
    // PlastiCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // PlastiCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // PlastiCoin: 3.5 days
static const int64 nTargetSpacing = 150; // PlastiCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PlastiCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PlastiCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // PlastiCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9f3b75b03b2b350b09cdc3d452e6df4946eeb496a056497c53c5e3f7a6ff89b5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "L33T";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("560c9fc8003c229cc3c9626992dff04729c101524b8477a07a74b016f80975ca4b2b6b01c937abfcb939c0fd10c07937ade8aed50d6eb9b38ed5d30f0ab18a2379") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514917640;
        block.nBits    = 504365644;
        block.nNonce   = 2027527816;

        if (fTestNet)
        {
            block.nTime    = 1514917640;
            block.nNonce   = 4050316941;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb3c113c5882d0b046701f66a2e916ea9aebc6578486c3c3d718dba024288dba2"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // PlastiCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PlastiCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PlastiCoinMiner : ProcessBlock, block not accepted");
    }
